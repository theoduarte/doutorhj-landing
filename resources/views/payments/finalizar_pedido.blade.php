    ...
    <section class="pagamento">
        <div class="container">
            <div class="area-container">
                <div class="titulo text-success">
                    <span class="text-success"><strong>SEU PEDIDO FOI FINALIZADO COM SUCESSO</strong></span>
                </div>
                <div class="row">
                                ...
                                <div id="accordion">
                                    ...
                                    <div class="card card-resumo-compra">
                                        <div class="card-header" id="heading_{{ $agendamento->id }}">
                                            <div class="row">
                                                <div class="nome-produto col-12 col-sm-8" data-toggle="collapse" data-target="#collapse_{{ $agendamento->id }}" aria-expanded="true" aria-controls="collapse_{{ $agendamento->id }}">
                                                    <span>{{ $agendamento->atendimento->ds_preco }}</span>
                                                </div>
                                                <div class="valor-produto col-12 col-sm-4">
                                                    <span>TOKEN DE ATENDIMENTO: {{ $agendamento->te_ticket }}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div id="collapse_{{ $agendamento->id }}" class="collapse show" aria-labelledby="heading_{{ $agendamento->id }}" data-parent="#accordion">
                                            <div class="card-body">
                                                <div class="linha-resumo">
                                                	<div class="row">
                                                		<div class="nome-produto col-12 col-sm-4">
                                                       ...
                                                       <div class="nome-produto col-12 col-sm-4">
                                                            ...
                                                            <div class="dados-resumo text-right">
                                                                <h3><strong>R$ {{ $agendamento->itempedidos->first()->getVlItempedido() }}</strong></h3>
                                                            </div>
                                                       </div>
                                                    </div>
                                                </div>
                                                <div class="linha-resumo">
                                                	<div class="row">
                                                		<div class="nome-produto col-12 col-sm-4">
                                                            ...
                                                            <div class="dados-resumo">
                                                                <p>Dr. {{ $agendamento->profissional->nm_primario.' '.$agendamento->profissional->nm_secundario }}</p>
                                                       ...
                                                       <div class="nome-produto col-12 col-sm-4">
                                                            ...
                                                            <div class="dados-resumo">
                                                                <p>{{ date('d/m/Y', strtotime($agendamento->dt_atendimento)) }} - {{ strftime('%A', strtotime($agendamento->dt_atendimento)) }}</p>
                                                            </div>
                                                       </div>
                                                    </div>
                                                </div>
                                    ...
                                    @endforeach
                                     <div class="card card-resumo-compra">
                                        <div class="card-header" id="heading_valor_total">
                                            <div class="row">
                                                <div class="nome-produto col-12 col-sm-8" data-toggle="collapse" data-target="#collapse_valor_total" aria-expanded="true" aria-controls="collapse_valor_total">
                                                    <h4>VALOR TOTAL DO PEDIDO</h4>
                                                </div>
                                                <div class="valor-produto col-12 col-sm-4">
                                                    <h3><strong>R$ {{ number_format( $valor_total_pedido,  2, ',', '.') }}</strong></h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
