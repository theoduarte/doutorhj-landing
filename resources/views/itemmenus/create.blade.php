...
<div class="container-fluid">
	<div class="row">
		<div class="col-sm-12">
			<div class="page-title-box">
				<h4 class="page-title">DoutorHJ</h4>
				<ol class="breadcrumb float-right">
					<li class="breadcrumb-item"><a href="/">Home</a></li>
					<li class="breadcrumb-item"><a href="{{ route('itemmenus.index') }}">Lista de Itens</a></li>
	...
	<div class="row">
		<div class="col-md-6 offset-md-3">
			<div class="card-box">
				<h4 class="header-title m-t-0">Adicionar Item de Menu</h4>
				
				<form action="{{ route('itemmenus.store') }}" method="post">
					...
					<div class="form-group">
						...
						<input type="text" id="url" class="form-control" name="url" placeholder="URL" required  >
					</div>
					
					<div class="form-group">
						<label for="ic_menu_class">Icon Class</label>
						<input type="text" id="ic_item_class" class="form-control" name="ic_item_class" placeholder="Classe do Ícone" maxlength="250"  >
					</div>
					
					<div class="form-group">
						<label for="ordemexibicao">Ordem de Exibição<span class="text-danger">*</span></label>
						<input type="number" id="ordemexibicao" class="form-control" name="ordemexibicao" placeholder="Ordem de Exibição" min="0" required  >
					</div>
