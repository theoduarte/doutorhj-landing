                ...
                <div class="row">
                    <div class="col-md-12 col-lg-6">
                        <div class="boas-vindas-cadastro">
                            <h4>Parabens!</h4>
                            <p>Seu cadastro foi concluído com sucesso. Você recebera um novo email com mais informações sobre o Doutor Hoje.
                                <br><br>Para logar na sua conta, digite seu celular e insira o token que receberá por SMS e E-mail.</p>
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-6">
