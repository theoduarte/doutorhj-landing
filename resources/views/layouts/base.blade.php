...
@push('style')
    ...
    <!-- Google fonts -->
        ...
        <script src="/libs/home-template/js/switchery.js"></script>
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="dropdown opcoes-menu-usuario drop-notificacoes">
                                        <button class="btn dropdown-toggle btn-notificacoes btn-area-logada"
                                                title="Notificações" type="button" id="dropdownNotificacoes"
                                ...
                                <li>
                                    <div class="dropdown opcoes-menu-usuario drop-carrinho">
                                        <button class="btn dropdown-toggle btn-carrinho btn-area-logada"
                                                title="Carrinho de Compras" type="button" id="dropdownCarrinho"
                                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
...
@push('scripts')
    ...
    <script type="text/javascript"
            src="/libs/mjolnic-bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js"></script>
