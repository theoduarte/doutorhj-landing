            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="icone-condicoes">
                            <img src="/landingpages/caixa/img/icone-cond1.png" alt="">
                        </div>
                        <div class="texto-condicoes">
                            <strong>30%</strong> de bônus no primeiro agendamento (Qualquer consulta e exame).
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-6">
                        <div class="icone-condicoes">
                            <img src="/landingpages/caixa/img/icone-cond2.png" alt="">
                        </div>
                        <div class="texto-condicoes">
                            <strong>Isenção</strong> de mensalidade ao plano Doutor Hoje PLUS (100% de desconto no
                            primeiro ano).
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion" id="accordionPerguntas">
                    <div class="card">
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionPerguntas">
                            <div class="card-body">
                                Basta realizar sua primeira compra no site <a href="https://www.doutorhoje.com.br">www.doutorhoje.com.br</a>
                                e pagar com seu cartão de crédito da caixa utilizando o seu cupom de desconto. <strong>O
                                    cupom de desconto é composto dos 6 primeiros dígitos do seu cartão.</strong>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-header" id="headingTwo">
                            <h5 class="mb-0">
                                <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                    Quais cartões estão participando da promoção?
                                </button>
                            </h5>
                        </div>
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionPerguntas">
                            <div class="card-body">
                                Todos os cartões de crédito emitidos pela Caixa.
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div class="card-header" id="headingFour">
                            <h5 class="mb-0">
                                <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                    Posso comprar consulta e exames para meus amigos e agregados utilizando as vantagens
                                    do Doutor Hoje?
                                </button>
                            </h5>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-3">
                    <img class="logo" src="/landingpages/caixa/img/logo-branca-doutor-hoje.png" alt="Doutor Hoje">
                </div>
                <div class="col-sm-12 col-md-3">
                    <div class="contato">
                ...
                <div class="col-sm-12 col-md-3">
                    <div class="contato">
                        <span>WhatsApp</span>
                        <p><i class="fab fa-whatsapp-square"></i> (61) 9 8679-2680</p>
                    </div>
                </div>
                <div class="col-sm-12 col-md-3">
                    <div class="contato">
