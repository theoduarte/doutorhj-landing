...
$( function() {
        $( "#nr_cep" ).blur(function() { 
        	$.ajax({
        	  url: "/profissional/consulta-cep/cep/"+this.value,
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">CADASTRO DO PROFISSIONAL</div>
				
                <div class="panel-body" style="height:auto;min-height: 241px;">
                    <form class="form-horizontal" method="POST" action="/profissional/gravar">
                        {{ csrf_field() }}
...
<!--                         </div>	 -->
                          		...
                          		<div class="ui-widget">
    								<select id="cd_especialidade" class="form-control" name="cd_especialidade" required autofocus>
                                        ...
                                        @foreach ($arEspecialidade as $json)
            								<option value="{{ $json->cd_especialidade }}" {{(old('cd_especialidade') == $json->cd_especialidade ? 'selected' : '')}}>{{ $json->ds_especialidade }}</option>
                                        @endforeach
        							</select>
                                </div>
                        
                                @if ($errors->has('cd_especialidade'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('cd_especialidade') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>	
						...
						<div class="col-md-10">
    						...
    						<div class="col-md-10">	
    						    <div class="form-group{{ $errors->has('tp_documento') ? ' has-error' : '' }}">
                                    <label for="tp_documento" class="col-md-4 control-label">Informe um documento</label>
                                    <div class="col-md-4">
                                ...
                                <div class="form-group{{ $errors->has('nr_crm') ? ' has-error' : '' }}">
                                    <label for="nr_crm" class="col-md-4 control-label">CRM/UF</label>
        
                                    <div class="col-md-4">
                                        <input id="nr_crm" type="text" class="form-control" name="nr_crm" value="{{ old('nr_crm') }}" required autofocus maxlength="50">
        
                                        @if ($errors->has('nr_crm'))
                                            <span class="help-block">
                                                <strong>{{ $errors->first('nr_crm') }}</strong>
                                            </span>
                                        @endif
                                    </div>	
                                    <div class="col-md-2">
            							<select id="uf_crm" class="form-control" name="uf_crm" required autofocus>
                                            ...
                                            @foreach ($arEstados as $json)
                								<option value="{{ $json->cd_ibge }}" {{(old('sg_estado') == $json->sg_estado ? 'selected' : '')}}>{{ $json->sg_estado }}</option>
                                            @endforeach
            							</select>
                                        @if ($errors->has('uf_crm'))
                                            <span class="help-block">
                                                <strong>{{ $errors->first('uf_crm') }}</strong>
                                            </span>
                                        @endif
                                    </div>
                                </div>
    						    ...
    						    <div class="form-group{{ $errors->has('tp_contato1') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-4">
            							<select id="tp_contato1" name="tp_contato1" class="form-control">
        									<option value="" selected="selected"></option>
        									<option value="FR" {{(old('tp_contato1') == 'FR' ? 'selected' : '')}}>Fixo Residencial</option>
        									<option value="FC" {{(old('tp_contato1') == 'FC' ? 'selected' : '')}}>Fixo Comercial</option>
        									<option value="CP" {{(old('tp_contato1') == 'CP' ? 'selected' : '')}}>Celular Pessoal</option>
					    ...
					    <div class="form-group{{ $errors->has('sg_logradouro') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-2">
    							<select id="sg_logradouro" name="sg_logradouro" class="form-control" required autofocus>
									<option value="" selected="selected"></option>
                        ...
                        <div class="form-group{{ $errors->has('nm_cidade') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3">
                                <input id="nm_cidade" type="text" class="form-control" name="nm_cidade" value="{{ old('nm_cidade') }}" required autofocus maxlength="50">
                        ...
                        <div class="form-group{{ $errors->has('sg_estado') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3">
    							...
    							<select id="sg_estado" class="form-control" name="sg_estado">
    								<option></option>
                                    @foreach ($arEstados as $json)
