                        ...
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                            ...
                            <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-cadastro"
                               role="tab" aria-controls="v-pills-home" aria-selected="true"><i
                                        class="fa fa-caret-right"></i> Cadastro</a>
                            <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-pagamento"
                               role="tab" aria-controls="v-pills-profile" aria-selected="false"><i
                                        class="fa fa-caret-right"></i> Pagamento</a>
                            <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill"
                               href="#v-pills-notificacoes" role="tab" aria-controls="v-pills-messages"
                               aria-selected="false"><i class="fa fa-caret-right"></i> Notificações</a>
                            <a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-sugestoes"
                               role="tab" aria-controls="v-pills-settings" aria-selected="false"><i
                                        class="fa fa-caret-right"></i> Deixe sua Sugestão</a>
                            <a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-sair"
                               role="tab" aria-controls="v-pills-settings" aria-selected="false"><i
                                        class="fa fa-caret-right"></i> Sair</a>
                        </div>
                    </div>
                                            ...
                                            <fieldset disabled>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="inputNome" class="form-control"
                                                           value="{{ $user_paciente->paciente->nm_primario.' '.$user_paciente->paciente->nm_secundario }}"
                                                           placeholder="Nome completo">
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputEmail">Email</label>
                                                    <input type="email" id="inputEmail" class="form-control"
                                                           value="{{ $user_paciente->email }}" placeholder="Email">
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputTelefone">Telefone</label>
                                                    <input type="text" id="inputTelefone" class="form-control"
                                                           value="{{ $user_paciente->paciente->contatos->first()->ds_contato }}"
                                                ...
                                                <div class="dependente">
                                                    <div class="row">
                                                        <div class="col-md-10">
                                                            ...
                                                            <input type="hidden"
                                                                   id="dependente_{{ $dependentes[$i]->id }}"
                                                                   class="dependente_id"
                                                                   value="{{ $dependentes[$i]->id }}">
                                                        </div>
                                                        <div class="col-md-2">
                                                        ...
                                                        <form>
                                                            ...
                                                            <div class="form-row">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                       id="inputNomeDependente" placeholder="Nome *"
                                                                       maxlength="50">
                                                                <input type="hidden" id="inputPacienteId"
                                                                       value="{{ $user_paciente->paciente->id }}">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="inputNomeDependente">Sobrenome</label>
                                                                <input type="text" class="form-control"
                                                                       id="inputNmSecundarioDependente"
                                                                       placeholder="Sobrenome *" maxlength="100">
                                                            </div>
                                                            <div class="form-row">
                                                                <div class="form-group col-md-4">
                                                                    <label for="tp_documento_dependente"
                                                                           class="control-label">Tipo Documento</label>
                                                                    <select id="tp_documento_dependente"
                                                                            class="form-control"
                                                                            name="tp_documento_dependente">
                                                                ...
                                                                <div class="form-group col-md-8">
                                                                    <label for="te_documento_dependente"
                                                                           class="control-label">Nr. Documento</label>
                                                                    <input type="text" id="te_documento_dependente"
                                                                           class="form-control"
                                                                           name="te_documento_dependente"
                                                            ...
                                                            <div class="form-group form-row">
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <select id="selectGeneroDependente"
                                                                            class="form-control">
                                                                ...
                                                                <div class="col-md-8">
                                                                    ...
                                                                    <select id="selectParentescoDependente"
                                                                            class="form-control">
                                                            ...
                                                            <div class="form-row">
                                                                <div class="col-md-12 text-center">
                                                                    <button type="button" id="btn-add-dependente"
                                                                            class="btn btn-vermelho"
                                                                            style="width: 200px;"><i
                                                                                class="fa fa-floppy-o"></i><span
                                                                                id="lbl-add-dependente"
                                                                                style="margin-left: 10px;"> Adicionar <i
                                                                    ...
                                                                    <div class="col col-12 col-sm-12 col-md-6 codigo-seguranca">
                                                                        ...
                                                                        <div class="area-codigo-seguranca">
                                                                            ...
                                                                            <i class="fa fa-credit-card"
                                                                               data-toggle="tooltip"
                                                                               data-placement="top"
                                                                               title="Código de segurança ou CVV são os 3 dígitos eu ficam no verso do seu cartão."></i>
                                                                        </div>
                                                                    </div>
                                                                </div>
                            ...
                            <div class="tab-pane fade" id="v-pills-notificacoes" role="tabpanel"
                                ...
                                <div class="opcoes-notificacao">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-lg-2">
                                            <input id="toggleLembreteMobile" type="checkbox"
                                                   class="mobile-lembrete" checked>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="tit-opc-not col-md-9 col-lg-5">
                                ...
                                <div class="itens-sair">
                                    ...
                                    <div class="btns-sair">
                                        <button type="button" class="btn btn-light"
                                                onclick="window.location.href='{{ route("logout") }}'">Sim
                                        </button>
