                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="tab-content" id="myTabContent">
                                                <div class="tab-pane fade show active" id="tabBlueTermos" role="tabpanel" aria-labelledby="home-tab">
                                                    ...
                                                    <p>Por este instrumento, de um lado o a <strong>DOUTOR HOJE
                                                            TECNOLOGIA LTDA</strong>,
                                                        Nome Fantasia: <strong>DOUTOR HOJE</strong>, pessoa jurídica de
                                                        direito privado,
                                                        ...
                                                        designada <span>CONTRATADA</span>, e do outro lado, o <strong>CLIENTE</strong>,
                                                        designado e
                                                        qualificado no preâmbulo deste contrato, adiante designado
                                                        <span>CLIENTE</span>, resolvem celebrar este
                                                        <strong>CONTRATO</strong> de acordo com as
                                                        cláusulas e condições a seguir.</p>
                                                    <h3>CLÁUSULA PRIMEIRA – DO OBJETO</h3>
                                                    <p><strong>1.1</strong> O presente Contrato tem por objeto o
                                                        fornecimento dos
                                                        produtos e serviços oferecidos pela plataforma digital <strong>DOUTOR
                                                            HOJE</strong>, que consiste no agendamento e pagamento de
                                                        consultas e
                                                        exames médicos a serem realizados na rede contratada da <strong>DOUTOR
                                                            HOJE.</strong></p>
                                                    <p><strong>1.2</strong> Fazem parte deste Contrato os Termos de Uso
                                                        e Política de
                                                        Privacidade da plataforma <strong>DOUTOR HOJE</strong>,
                                                        constante na área logada
                                                        do site
                                                        <a href="www.doutorhoje.com.br">www.doutorhoje.com.br</a>, bem
                                                        como eventuais anexos e
                                                        benefícios adicionais, quando for o caso.</p>
                                                    <h3>CLÁUSULA SEGUNDA - DAS OBRIGAÇÕES DAS PARTES</h3>
                                                    <p><strong>2.1</strong> São obrigações do <strong>CLIENTE:
                                                            a)</strong> acessar o site
                                                        <a href="www.doutorhoje.com.br">www.doutorhoje.com.br</a>, para
                                                        o agendamento e pagamentos das
                                                        consultas e exames, cujo acesso será pessoal e protegido por
                                                        senha definida para cada <strong>CLIENTE,</strong> a cada novo
                                                        acesso. <strong>b)</strong>
                                                        fornecer os dados necessários para o cadastro, tais como: I)
                                                        nome; II) data de nascimento; III) número CPF; IV) Telefone
                                                        celular; V) e-mail. <strong>c)</strong> pagar pelos serviços
                                                        contratados na forma
                                                        estipulada na Cláusula do Pagamento.</p>
                                                    <p><strong>2.2</strong> São obrigações da <strong>CONTRATADA:
                                                            a)</strong> disponibilizar rede de
                                                        prestadores de serviços parceiros nas diversas especialidades
                                                        reconhecidas pelo Conselho Federal de Medicina;
                                                        <strong>b)</strong> efetuar a
                                                        cobrança direta dos valores referentes a consultas e exames
                                                        médicos contratados pelos <strong>CLIENTES. c)</strong>
                                                        ...
                                                        <strong>não se responsabilizando, em nenhuma hipótese,</strong>
                                                        pela qualidade do
                                                    ...
                                                    <h3>CLÁUSULA TERCEIRA – DO PRODUTO, VALORES, PAGAMENTO E
                                                        REAJUSTE</h3>
                                                    <p><strong>3.1</strong> O produto <strong>DOUTOR HOJE</strong>
                                                        disponibilizado ao <strong>CLIENTE</strong> será o
                                                        Produto <strong>BLUE</strong>, que possui as seguintes
                                                        características:</p>
                                                    <p><strong>3.1.1</strong> Aquisição de Consultas a R$ 29,50 (vinte e
                                                        nove reais e
                                                    ...
                                                    <p><strong>3.1.2</strong> Demais consultas e exames, em qualquer
                                                        localidade onde haja
                                                        rede <strong>DOUTOR HOJE,</strong> com preços especiais para o
                                                        produto <strong>BLUE,</strong>
                                                        conforme constam no site <a href="www.doutorhoje.com.br">www.doutorhoje.com.br</a>.
                                                    </p>
                                                    <p><strong>3.1.3</strong> Desconto em medicamentos: desconto nas
                                                        farmácias
                                                        conveniadas à DOUTOR HOJE.</p>
                                                    <p><strong>3.1.4</strong> Orientação Médica por Telefone: Serviço de
                                                        orientação
                                                        médica aos <strong>CLIENTES</strong> da <strong>DOUTOR
                                                            HOJE</strong>, que visa ampliar o acesso às
                                                    ...
                                                    <p><strong>3.2</strong> Para a utilização da plataforma <strong>DOUTOR
                                                            HOJE</strong> o <strong>CLIENTE</strong> pagará
                                                        à <strong>CONTRATADA a assinatura mensal de R$ 35,50 (trinta e
                                                            cinco
                                                            reais e cinquenta centavos), por CLIENTE cadastrado (por
                                                            pessoa
                                                            inscrita), referente ao produto BLUE.</strong> O pagamento
                                                        será realizado
                                                        por meio de cartão de crédito.</p>
                                                    <p><strong>3.3</strong> A vigência destes benefícios terá início a
                                                        contar da data do
                                                        primeiro pagamento, sendo esta a data de vencimento das demais
                                                        parcelas mensais.</p>
                                                    <p><strong>3.4</strong> Os valores estipulados nesta cláusula
                                                        poderão ser reajustados
                                                        anualmente.</p>
                                                    <p><strong>3.5</strong> As aquisições de consultas e exames serão
                                                        pagos diretamente
                                                        pelos <strong>CLIENTES</strong> ao <strong>DOUTOR HOJE</strong>.
                                                        Os valores dos exames constam no
                                                        site <a href="www.doutorhoje.com.br">www.doutorhoje.com.br</a>,
                                                        de acordo com o produto descrito
                                                        nesta Cláusula, e podem sofrer alterações a qualquer tempo. A
                                                        tabela de consultas será reajustada anualmente.</p>
                                                    <p><strong>3.6</strong> O <strong>CLIENTE</strong> poderá exercer o
                                                        direito de arrependimento,
                                                        desistir da aquisição dos benefícios da <strong>DOUTOR
                                                            HOJE</strong> e ser
                                                    ...
                                                    <p><strong>4.1</strong> O presente Contrato vigorará a partir da
                                                        data da sua
                                                        assinatura por prazo indeterminado.</p>
                                                    <p><strong>4.2</strong> <strong>Fidelidade:</strong> Este contrato
                                                        não poderá ser rescindido ou
                                                    ...
                                                    <p><strong>4.3</strong> Após a vigência inicial de 12 (doze) meses,
                                                        este contrato
                                                        poderá ser rescindido a qualquer tempo, sem multa, mediante
                                                        solicitação do <strong>CLIENTE</strong> pela Central de
                                                        Atendimento ou pelo site
                                                        <a href="www.doutorhoje.com.br">www.doutorhoje.com.br</a>.</p>
                                                    <h3>CLÁUSULA QUINTA - USO DA REDE DOUTOR HOJE</h3>
                                                    <p><strong>5.1</strong> A utilização da rede de assistência de
                                                        consultas e exames se
                                                        ...
                                                        <strong>CLIENTE</strong> é um pré-agendamento, que será
                                                        confirmado pelo DOUTOR
                                                        HOJE em até 48 (quarenta e oito) horas.</p>
                                                    <h3>CLÁUSULA SEXTA – DO FORO</h3>
                                                    <p><strong>6.1</strong> As partes elegem o foro da Circunscrição
                                                        Judiciária de
                                                ...
                                                <div class="tab-pane fade" id="tabBlackTermos" role="tabpanel" aria-labelledby="profile-tab">
                                                    ...
                                                    <p>Por este instrumento, de um lado o a <strong>DOUTOR HOJE
                                                        ...
                                                        Sul, CEP 70.303-907, na cidade de Brasília, Distrito Federal,
                                                        neste ato representada na forma de seu Contrato Social, adiante
                                                        designada <strong>CONTRATADA,</strong> e do outro lado, o
                                                        <strong>CLIENTE,</strong> designado e
                                                        qualificado no preâmbulo deste contrato, adiante designado
                                                        <strong>CLIENTE,</strong> resolvem celebrar este <strong>CONTRATO</strong>
                                                        de acordo com as
                                                        cláusulas e condições a seguir. </p>
                                                    <h3>CLÁUSULA PRIMEIRA – DO OBJETO</h3>
                                                    <p><strong>1.1</strong> O presente Contrato tem por objeto o
                                                    ...
                                                    <p><strong>3.1</strong> O produto <strong>DOUTOR HOJE</strong>
                                                        disponibilizado ao <strong>CLIENTE</strong> será o
                                                        Produto <strong>BLACK,</strong> que possui as seguintes
                                                        características:</p>
                                                    <p><strong>3.1.1</strong> Bônus de 5 (cinco) Consultas por ano, por
                                                        <strong>CLIENTE,</strong> no
                                                        ...
                                                        serem realizadas <strong>exclusivamente na rede credenciada
                                                            indicada e
                                                            agendada pela Central de Atendimento DOUTOR HOJE.</strong>
                                                    </p>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <p>b) Consultas e exames, em qualquer localidade onde haja
                                                                rede <strong>DOUTOR HOJE,</strong> com preços especiais
                                                                para o produto
                                                    ...
                                                    <p><strong>3.2</strong> Para a utilização da plataforma <strong>DOUTOR
                                                            HOJE</strong> o <strong>CLIENTE</strong> pagará
                                                        à <strong>CONTRATADA</strong> a <strong>assinatura mensal de R$
                                                            69,50 (sessenta e nove
                                                            reais e cinquenta centavos), por CLIENTE cadastrado (por
                                                            pessoa
                                                            inscrita), referente ao produto BLACK.</strong> O pagamento
                                                        será
                                                    ...
                                                    <p><strong>5.1</strong> A utilização da rede de assistência de
                                                        ...
                                                        faz exclusivamente por meio de uso da plataforma digital pelo
                                                        site <a href="www.doutorhoje.com.br">www.doutorhoje.com.br</a>
                                                        ou pelo aplicativo. O cliente faz a
                                                        escolha da consulta ou exame, da especialidade, dia e horário
                                                        pretendidos, e após, efetua o pagamento, por cartão de crédito,
                                                        transferência bancária. O dia e o horário indicados pelo
                                                        <strong>CLIENTE</strong>
                                                        é um pré-agendamento, que será confirmado pelo <strong>DOUTOR
                                                            HOJE</strong> em
