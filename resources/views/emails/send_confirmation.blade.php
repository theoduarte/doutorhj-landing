    ...
    <body>
        ...
        <table width='600' border='0' cellspacing='0' cellpadding='0' align='center'>
            <tr>
                ...
                <td width='540' style='font-family:Arial, Helvetica, sans-serif; font-size: 16px; line-height: 26px; color: #434342; background-color: #fff; text-align: center;'>Bem-Vindo! Falta muito pouco para concluirmos o seu cadastro. Em breve nossa equipe entrará em contato para finalizar o processo de assinatura.</td>
                <td width='30' style='background-color: #fff;'>&nbsp;</td>
            </tr>
        </table>
        <br>
