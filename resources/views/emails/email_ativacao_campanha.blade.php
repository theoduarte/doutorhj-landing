...
<html>
    ...
    <body>
        ...
        <table width='600' border='0' cellspacing='0' cellpadding='0' align='center'>
            <tr>
                <td width='30' style='background-color: #fff;'>&nbsp;</td>
                <td width='540' style='font-family:Arial, Helvetica, sans-serif; font-size: 16px; line-height: 26px; color: #434342; background-color: #fff;'>Obrigado por assinar o Doutor Hoje. Sua inscrição está pronta, só é preciso que você ative seu cadastro para começar a agendar suas consultas e exames.</td>
                <td width='30' style='background-color: #fff;'>&nbsp;</td>
            </tr>
        </table>
        <br>
        ...
        <table width='600' border='0' cellspacing='0' cellpadding='0' align='center'>
            <tr>
                <td width='29' style='background-color: #fff;'>&nbsp;</td>
                ...
                <td width='31' style='background-color: #fff;'>&nbsp;</td>
            </tr>
        </table>
        <table width='600' border='0' cellspacing='0' cellpadding='0' align='center'>
            <tr>
        ...
        <table width='600' border='0' cellspacing='0' cellpadding='0' align='center'>
            <tr>
                ...
                <td width='540' style='font-family:Verdana, Helvetica, sans-serif; font-size: 16px; line-height: 46px; background-color: #1d70b7; text-align: center;'><a href='{{$url}}' style='color: #ffffff; text-decoration: none;'>Ative seu cadastro e começe a cuidar da sua saúde</a></td>
                <td width='30' style='background-color: #1d70b7;'>&nbsp;</td>
            </tr>
        </table>
        <br>
