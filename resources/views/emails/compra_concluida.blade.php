...
<html>
    ...
    <body>
        ...
        <table width='600' border='0' cellspacing='0' cellpadding='0' align='center'>
            <tr style='background-color:#fff;'>
                <td width='600' style='text-align:center'><span style='font-family:Arial, Helvetica, sans-serif; font-size:10px; color:#bbb;'>Doutor Hoje - Pré-agendamento concluído</span></td>
            </tr>
        </table>
        <br>
        <table width='600' border='0' cellspacing='0' cellpadding='0' align='center'>
        ...
        <table width='600' border='0' cellspacing='0' cellpadding='0' align='center'>
            <tr>
                <td width='30' style='background-color: #fff;'>&nbsp;</td>
                <td width='540' style='font-family:Arial, Helvetica, sans-serif; font-size: 20px; line-height: 30px; color: #434342; background-color: #fff; text-align: center;'>Você <strong>pré agendou</strong> seu atendimento, aguarde a confirmação da sua consulta ou exame por e-mail em <strong>até 48 horas.</strong> <br>
                    Você pode acompanhar o processo na sua área logada no site do Doutor Hoje.
                </td>
                <td width='30' style='background-color: #fff;'>&nbsp;</td>
            </tr>
        </table>
        ...
        <table width='600' border='0' cellspacing='0' cellpadding='0' align='center'>
            <tr>
                ...
                <td width='540' style='font-family:Arial, Helvetica, sans-serif; font-size: 22px; line-height: 60px; background-color: #1d70b7; text-align: center; color: #fff;'>Informações da sua consulta/exame
                </td>
                <td width='30' style='background-color: #1d70b7;'>&nbsp;</td>
            </tr>
        </table>
        ...
        <table width='600' border='0' cellspacing='0' cellpadding='0' align='center'>
            <tr>
                <td width='30' style='background-color: #fff;'>&nbsp;</td>
                <td width='540' style='font-family:Arial, Helvetica, sans-serif; font-size: 18px; line-height: 18px; color: #a21b26; background-color: #fff; text-align: center;'>Obrigado por escolher o Doutor Hoje para cuidar da sua saúde!</td>
                <td width='30' style='background-color: #fff;'>&nbsp;</td>
            </tr>
        </table>
        <br>
