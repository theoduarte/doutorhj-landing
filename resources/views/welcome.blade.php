            ...
            <div class="container">
                <div class="busca-home">
                    ...
                    <form action="/resultado" class="form-busca-home" method="get"
                          onsubmit="return validaBuscaAtendimento()">
                        <div class="row">
                        ...
                        <form action="/resultado" class="form-busca-home" method="get"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12 col-lg-3">
                                    <label for="local">Local de antedimento</label>
                                    <!-- <input type="text" id="local_atendimento" class="form-control cvx-local-atendimento" name="local_atendimento" placeholder="Ex.: Asa Sul"> -->
                                    <select id="local_atendimento" class="form-control select2"
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-6 col-xl-6 order-lg-2 box-banner-conheca">
                            <div class="area-imagem">
                                <img src="/libs/home-template/img/banner-participe.jpg"
                                     alt="Venha fazer parte você também">
                            </div>
                        </div>
