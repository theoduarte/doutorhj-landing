@extends('layouts.base')@section('title', 'Pagamento - DoutorHJ')
@push('scripts')
@endpush
@section('content')
    <style>
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row cartaocredito" style="display:none">
                                    ...
                                    <div class="col-sm-12 col-md-12">
                                        ...
                                        <form action="">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control cartaoCadastradoCredito cartaoCadastrado" id="cartaoCadastrado">
                                                    ...
                                                    @foreach($cartoes_gravados as $item)
                                                        <option value="{{ $item->id }}">Cartão {{ $item->bandeira }} -
                                                            final {{ $item->numero }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group codigo-seguranca">
                                                <label for="inputCodigoCredito" class="label-codigo-seguranca">Código de
                                                    segurança</label>
                                                <div class="area-codigo-seguranca">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="cnpj" style="display:none;">
                                                            <label for="inputCNPJCredito">CNPJ do titular do
                                                                cartão</label>
                                                        ...
                                                        <div class="cpf">
                                                            <label for="inputCPFCredito">CPF do titular do
                                                                cartão</label>
                                ...
                                <div class="boletoBancario" style="display:none; ">
                                    ...
                                    <div class="comendereco campos-endereco campos-pagamento">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label for="inputDocumento">Documento</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12" style="text-align:center; margin-top:2%">
                                            <img src="/img/boleto.png" style="align-self:center" alt="" class="boleto-banc" width="100">
                                        </div>
                                    </div>
                                </div>
                                <div class="row transferenciaBancaria" style="display:none;  padding-top:5%   ">
                                    <img src="/img/transferencia.png" style="display: block; margin: 0 auto; width: 100px; height: 60px" alt="" class="transferencia-banc">
                                </div>
                            </div>
                        </div>
                        {{-------------------------------------------
                                ...
                                <div class="output">
                                    ...
                                    <div id="credito" class="formas-pagamento">
                                        ...
                                        <div class="form-check fc-checkbox row-payment-card">
                                            ...
                                            <label class="form-check-label" for="checkGravarCartaoCredito">Gravar dados
                                                para futuras compras</label>
                                        </div>
                                    ...
                                    <div id="debito" class="formas-pagamento">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col col-12 col-sm-12 col-md-6 codigo-seguranca">
                                                <label for="inputCodigoDebito" class="label-codigo-seguranca">Código de
                                                    segurança</label>
                                                <div class="area-codigo-seguranca">
                                                        ...
                                                        <div class="valor-produto col-12 col-sm-12">
                                                            <select id="selectPacienteAgendamento_{{ $item['item_id'] }}" class="form-control select-paciente-agendamento" name="selectCartaoCredito">
                                                                ...
                                                                @foreach($pacientes as $paciente)
                                                                    <option value="{{ $paciente->id }}" @if($item['paciente']->id == $paciente->id) selected="selected" @endif>@if($paciente->responsavel_id == null)
                                                                            (T) @else
                                                                            <span>(D)</span> @endif {{ $paciente->nm_primario.' '.$paciente->nm_secundario }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="linha-resumo">
                                                            ...
                                                            <div class="dados-resumo dados-resumo-paciente">
                                                                <p class=" @if($item['paciente']->id != null) text-primary @else text-danger @endif">
                                                                    @if($item['paciente']->id != null) {{ $item['paciente']->nm_primario.' '.$item['paciente']->nm_secundario }} @else
                                                                        -- PACIENTE AINDA NÃO INDICADO-- @endif
                                                                </p>
                                                        ...
                                                        @else
                                                            <div class="linha-resumo">
                                                                ...
                                                                <div class="dados-resumo">
                                                                    <p>{{ $item['atendimento']->ds_atendimento }}
                                                                        <br><em>({{  $item['atendimento']->nome_especialidade }}
                                                                            )</em></p>
                                                                </div>
                                                            </div>
                                                        @endif
                                                        <div class="linha-resumo">
                                                            ...
                                                            <div class="dados-resumo">
                                                                <p>{{ $item['clinica']->nm_fantasia }} - Und:
                                                                    ( {{ $item['filial']->nm_nome_fantasia }} )</p>
                                                        ...
                                                        @if($item['data_agendamento'] != null && $item['data_agendamento'] != 'null')
                                                            <div class="linha-resumo">
                                                                ...
                                                                <div class="dados-resumo">
                                                                    <p>{{ date('d/m/Y', strtotime($item['data_agendamento'])) }}
                                                                        - {{ strftime('%A', strtotime($item['data_agendamento'])) }}</p>
                                                ...
                                                <div class="card-header" id="heading_{{$item['item_id']}}">
                                                    ...
                                                    <div class="row">
                                                        <div class="nome-produto col-12 col-sm-9" data-toggle="collapse" data-target="#collapse_{{$item['item_id']}}" aria-expanded="false" aria-controls="collapse_">
                                                            <span>Checkup {{$item['checkup']->titulo}}
                                                                - {{ucfirst($item['checkup']->tipo)}}</span>
                                                        </div>
                                                        <!--<div class="excluir-produto col-2 col-sm-1">
                                                            <a class="close-div" href="#"><i class="fa fa-trash"></i></a>
                                                            </div>-->
                                                                    ...
                                                                    <ul>
                                                                        @foreach($item['itens_checkup'] as $itemCheckup)
                                                                            @if(!is_null($itemCheckup->atendimento->consulta_id))
                                                                                ...
                                                                                <li>
                                                                                    <div class="clinica">
                                                                                        Consulta {{$itemCheckup->atendimento->consulta->ds_consulta}}
                                                                                        , no dia
                                                                                        <span>{{$itemCheckup->dataHoraAgendamento}}</span><br>
                                                                                    ...
                                                                                    <div class="endereco">
                                                                                        <span>Clinica: </span> {{$itemCheckup->atendimento->clinica->nm_fantasia}}
                                                                                        <br>
                                                                                ...
                                                                                <li>
                                                                                    <div class="clinica">
                                                                                        ...
                                                                                        @if(!is_null($itemCheckup->dataHoraAgendamento))
                                                                                            , no dia
                                                                                            <span>{{ $itemCheckup->dataHoraAgendamento}}</span>
                                                                                        @endif
                                                                                        <br>
                                                                                    </div>
                                                                                    <div class="endereco">
