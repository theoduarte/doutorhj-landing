...
<div class="container-fluid">
		...
		<div class="col-sm-12">
			<div class="page-title-box">
				...
				<ol class="breadcrumb float-right">
					...
					<li class="breadcrumb-item active">Adicionar Cargo</li>
				</ol>
	...
	<div class="row">
		<div class="col-md-6 offset-md-3">
			<div class="card-box">
				<h4 class="header-title m-t-0">Adicionar Cargo</h4>
				...
				<form action="{{ route('cargos.store') }}" method="post">
					...
					<div class="form-group">
						...
						<input type="text" id="cd_cargo" class="form-control" name="cd_cargo" required placeholder="Código do Cargo"  >
					</div>
					
					<div class="form-group">
						<label for="ds_cargo">Descrição<span class="text-danger">*</span></label>
						<input type="text" id="ds_cargo" class="form-control" name="ds_cargo" required placeholder="Descrição do Cargo" >
					</div>
