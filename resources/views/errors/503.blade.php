		...
		<div class="ex-page-content">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="message-box" style="vertical-align: middle;height: 100%;padding-top: 25%;">
                            <h1 class="m-b-0 text-warning">503</h1>
							<p>
                           		<h4>{{ json_decode(file_get_contents(storage_path('framework/down')), true)['message'] }}.</h4>
							</p>
							<p>
								<h4>Tente novamente após {{json_decode(file_get_contents(storage_path('framework/down')), true)['retry']}} minutos.</h4>
							</p>
