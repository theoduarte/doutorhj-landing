...
$(function(){
    ...
    $('[data-method]:not(:has(form))').append(function(){
        return "\n"+
        "<form action='"+$(this).attr('href')+"' method='POST' name='"+$(this).attr('data-form-name')+"' id='"+$(this).attr('data-form-name')+"' style='display:none'>\n"+
        "   <input type='hidden' name='_method' value='"+$(this).attr('data-method')+"'>\n"+
        "   <input type='hidden' name='_token' value='"+ laravel_token +"'>\n"+
        "   <input type='hidden' name='_message' value='"+$(this).attr('data-message')+"'>\n"+
        "</form>\n"
    })
    .removeAttr('href')
