...
class Checkup extends Model
{
    ...
    public function getSummary( $checkupId ) {
        return DB::select(" SELECT 1 ORDEM, CK.ID, CK.TITULO, TP.DS_ATENDIMENTO, E.DS_ESPECIALIDADE ESPECIALIDADE, 
                              ...
                              LEFT JOIN (SELECT MAX(ID) ID, CONSULTA_ID, CS_TAG
                            ...
                            UNION
                            SELECT 2 ORDEM, CK.ID, CK.TITULO, TP.DS_ATENDIMENTO, GP.DS_GRUPO ESPECIALIDADE, 
                              ...
                              LEFT JOIN (SELECT MAX(ID) ID, PROCEDIMENTO_ID, CS_TAG
                                     FROM TAG_POPULARS TP
